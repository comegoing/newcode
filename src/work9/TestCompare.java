...
class  Person  implements Comparable<Person>{
    ...
    public  int  compareTo(Person  o)  {
        // if((this.height*0.5+this.weight*0.5)>(o.height*0.5+o.weight*0.5)){
        //         return 1;
        // }
                
        // else if((this.height*0.5+this.weight*0.5)==(o.height*0.5+o.weight*0.5)){
        //         return 0;
        // }   
        // else{
        //         return -1;
        // }
        return (int)((this.height*0.5+this.weight*0.5)-(o.height*0.5+o.weight*0.5));
